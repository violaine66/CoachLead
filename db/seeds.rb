...
players_data = [
  ...
  { first_name: "Zine Dine", last_name: "Belomri", age: 20, job: "", user_id: users[1].id },
  { first_name: "Matéo", last_name: "Coprot", age: 21, job: "", weight: "", children_count: "", user_id: users[2].id },
  { first_name: "Gabriel", last_name: "Da silva", age: 19, job: "", weight: "", children_count: "", user_id: users[3].id },
  { first_name: "David", last_name: "Samuel", age: 19, job: "", weight: "", children_count: "", user_id: users[4].id },
  { first_name: "Valentin", last_name: "Delespaul", age: 26, job: "", weight: "", children_count: "", user_id: users[5].id },
  { first_name: "Junior", last_name: "Do Marcolino", age: 32, job: "", weight: "", children_count: "", user_id: users[6].id },
  { first_name: "Mathéo", last_name: "Flohic", age: 24, job: "", weight: "", children_count: "", user_id: users[7].id },
  { first_name: "Dominique", last_name: "Gomis", age: 17, job: "", weight: "", children_count: "", user_id: users[8].id },
  { first_name: "Hakim", last_name: "Lazreg", age: 34, job: "", weight: "", children_count: "", user_id: users[9].id },
  { first_name: "Matteo", last_name: "Louismet", age: 24,  job: "", weight: "", children_count: "", user_id: users[10].id },
  { first_name: "Ancelin", last_name: "Meder", age: 23,  job: "", weight: "", children_count: "", user_id: users[11].id },
  { first_name: "Fernandy", last_name: "Mendy", age: 31, job: "", weight: "", children_count: "", user_id: users[12].id },
  { first_name: "Arnaud", last_name: "Mendy", age: 29, job: "", weight: "", children_count: "", user_id: users[13].id },
  { first_name: "Alex", last_name: "Mendy", age: 24, job: "", weight: "", children_count: "", user_id: users[14].id },
  { first_name: "Jules", last_name: "Mouchet", age: 18,  job: "", weight: "", children_count: "", user_id: users[15].id },
  { first_name: "Astrid", last_name: "Mvondo", age: 27, job: "", weight: "", children_count: "", user_id: users[16].id },
  { first_name: "Nathan", last_name: "Rousse", age: 27,  job: "", weight: "", children_count: "", user_id: users[17].id },
  { first_name: "Damien", last_name: "Sculo", age: 34,  job: "", weight: "", children_count: "", user_id: users[18].id },
  { first_name: "Kaba", last_name: "Sylla", age: 23, job: "", weight: "", children_count: "", user_id: users[19].id },
  { first_name: "Hugo", last_name: "Minier", age: 28, job: "", weight: "", children_count: "", user_id: users[20].id },
  { first_name: "Evan", last_name: "Bautista", age: 17, job: "", weight: "", children_count: "", user_id: users[21].id },
  { first_name: "Wilson", last_name: "Legarez", age: 17, job: "", weight: "", children_count: "", user_id: users[22].id },
  { first_name: "Marlon", last_name: "Thorel", age: 18, job: "", weight: "", children_count: "", user_id: users[23].id },
  { first_name: "Killian", last_name: "Tual", age: 28,  job: "", weight: "", children_count: "", user_id: users[24].id },
  { first_name: "Yael", last_name: "Tual", age: 24,  job: "", weight: "", children_count: "", user_id: users[25].id },
  { first_name: "Antonin", last_name: "Namua", age: 30, job: "", weight: "", children_count: "", user_id: users[26].id }
]
